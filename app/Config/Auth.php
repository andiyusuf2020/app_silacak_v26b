...
class Auth extends \Myth\Auth\Config\Auth
{
    ...
    public $defaultUserGroup = 'useropdrfk';
    /**
     * --------------------------------------------------------------------
     * Landing Route
     * --------------------------------------------------------------------
     ...
     * @var int
     */
    public $hashTimeCost = 8; // PASSWORD_ARGON2_DEFAULT_TIME_COST;

    /**
     * @var int
     */
    public $hashThreads = 8; // PASSWORD_ARGON2_DEFAULT_THREADS;
    ...
    public $userActivators = [
        'Myth\Auth\Authentication\Activators\EmailActivator' => [
            'fromEmail' => 'andi@andiahmadyusuf.com',
            'fromName'  => 'SITAPIS',
        ],
    ];
