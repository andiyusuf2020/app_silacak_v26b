...
<body>
    ...
    ?>
    <h2 style="font-size:12px; text-align:center;">LAPORAN KINERJA PROGRAM TEMATIK PEMBANGUNAN DAERAH TA
        <?= esc($tahun) ?> <?= esc($bulantw) ?> <br><?= esc($datauser['sub_unit']) ?></h2><br>
    ...
    <table cellpadding="4" style="text-align:center">
        ...
        <tbody>
            <tr>
                ...
                <th style="font-size:9px; text-align:center; width:10%" rowspan="2"><strong>PROGRAM TEMATIK PEMBANGUNAN YANG DIDUKUNG</strong></th>
            ...
            foreach ($progtematik as $key => $dataprogtematik) { ?>
                <tr>
                    ...
                    <td style="border: 1px solid #000000; font-size:12px; text-align:left; width:96%;">
                        <strong><?= esc('Program Unggulan : ' . $dataprogtematik['nm_tematik']) ?></strong>
                ...
                foreach ($datasubkeg as $key => $subkeg) { ?>
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="border: 1px solid #000000; font-size:9px; text-align:left; width:22%;">
                                <?= esc($kegpokok['uraian_target']) ?><br><strong>HASIL YANG INGIN DICAPAI</strong>
                                <?= esc($kegpokok['hasil']) ?>
