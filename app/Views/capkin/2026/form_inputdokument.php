...
<div class="container">
    ...
    <?php if (!session()->getFlashdata('message')): ?>
        ...
        <div class="form-group">
            ...
            <code>
                <label><strong><?= esc($datarkp['nm_sub_giat']) ?></strong></label>
            </code>
        ...
        <div class="form-group">
            ...
            <code>
                <label><strong><?= esc($datarkp['nm_progprioritas']) ?></strong></label>
            </code>
            <?= form_hidden('kegiatan', esc($datarkp['nm_progprioritas'])); ?>
        </div>
        <div class="form-row">
            <div class="form-group">
