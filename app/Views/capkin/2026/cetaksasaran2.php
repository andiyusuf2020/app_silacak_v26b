...
<body>
    ...
    ?>
    <h2 style="font-size:12px; text-align:center;">LAPORAN KINERJA PROGRAM PRIORITAS PENDUKUNG SASARAN PEMBANGUNAN TA </h2>
    ...
    <table>
        ...
        <tr>
            <td colspan="2">
                <strong> Anggaran <?= esc($datauser['sub_unit']) ?> s.d. 30 <?= esc($bulan) ?> 2025
                    adalah sebesar Rp <?= esc(number_format($datarealisasi['realisasi'] ?? null, 0, ',', '.')) ?> atau …% dari total pagu DPA APBD TA 2025 sebesar Rp <?= esc(number_format(0, 0, ',', '.')) ?></strong>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="text-align:left; width:96%;">
                ...
                <?= esc($datauser['sub_unit']) ?> sampai Bulan <?= esc($bulan) ?> telah terealisasi sebanyak
                <?php
                // $jRA = count($rkegpokok);
                // echo $jRA;
                ?>
