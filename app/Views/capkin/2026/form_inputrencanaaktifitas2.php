                    ...
                    <div class="input-group row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <textarea name="data[0][hasil]" class="form-control" id="hasil" required
                                oninput="this.value = this.value.replace(/[^a-zA-Z0-9,.%()?/\s]/g, '')"
                                placeholder="Data ini diisi dari Indikator Outcome yang terukur di Dokumen RENSTRA OPD atau Dokumen RPJMD Provinsi Lampung 2025-2029 pada Tabel 3.6 MATRIKS PROGRAM PRIORITAS, OUTCOME DAN INDIKATOR" rows="5"></textarea>
                        </div>
                        <div class="col-md-1">
