...
<body>
    ...
    <h3 style="font-size:12px; text-align:center;">LAPORAN KINERJA KEGIATAN PENDUKUNG SASARAN PEMBANGUNAN <br>TA <?= esc($tahun) ?><br>
        <?= esc($datauser['sub_unit'] . '  ' . 'Pemerintah Provinsi Lampung') ?>
    </h3>
                            ...
                            ?>
                                ...
                                ?>
                                    ...
                                    <?php if (empty($rkegpokok)) {
                                        ...
                                        foreach ($rkegpokok as $key => $datarpokok) {
                                    ...
                                    ?>
                                            <tr>
                                                <td style=" font-size:9px; text-align:right; width:4%;"></td>
                                                <td style=" font-size:9px; text-align:left; width:96%;">
                                                    <?= esc('Realisasi Pelaksanaan Aktifitas/Keg.Pokok s.d Bulan ' . $datarpokok['bulan'] . ' Tahun ' . $tahunaktif) ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style=" font-size:9px; text-align:right; width:4%;"></td>
                                                <td style=" font-size:9px; text-align:left; width:96%;">
                                                    ...
                                                    <?= esc($datarpokok['r_target']) . ' ' . esc($datarpokok['sat_target']) ?>
                                                </td>
                                            </tr>
                                            <?php
                                            $dataDRKP = $this->rdkegpokokmodal->DataPerRKegPokok($datarpokok['id_r'] ?? null, $tahun);
                                            foreach ($dataDRKP as $key => $value) { ?>
                                                <tr>
                                                    <td style=" font-size:9px; text-align:right; width:4%;"></td>
                                                    <td style="font-size:9px; text-align:right; width:4%;">-</td>
                                                    <td style=" font-size:9px; text-align:left; width:92%;">
                                                        <br><strong><?= esc($datarpokok['r_uraian']) . ' dengan realisasi :' ?>
                                                            <?= esc($datarpokok['r_target']) . ' ' . esc($datarpokok['sat_target']) ?>
                                                        </strong>
    ...
    <div style="font-size:13px;text-align:left;" width:20%>
        <table width:20%>
            <tr>
                <td style="font-size:9px" width:20%>Mengetahui</td>
            </tr>
            <tr>
                <td style="font-size:9px" width:20%><?= esc($datauser['jabatan']) ?></td>
            </tr>
            <tr>
                <td></td>
            </tr>
            ...
            <tr>
                <td style="font-size:9px"><u><?= esc($datauser['nama']) ?></u></td>
            </tr>
            <tr>
                <td style="font-size:9px"><?= esc($datauser['nip']) ?></td>
            </tr>
        </table>
    </div>
</body>
