...
<div class="container-fluid">
    <div class="container">
        ...
        <div class="action-buttons">
            <form action="<?= base_url('adminprov/capkin') ?>" method="get" class="search-form">
                <?= csrf_field(); ?>
                <input type="text" name="keyword" placeholder="Cari lokasi..." value="<?= $keyword ?? '' ?>">
                <input type="hidden" name="nmSU" value="<?= esc($nama_opd) ?>">
                <input type="hidden" name="kdSU" value="<?= esc($kdSU) ?>">

                <button type="submit"><i class="bi bi-search"></i></button>
            </form>

            <div class="filter-kategori">
                <form action="<?= base_url('adminprov/capkin') ?>" method="get">
                    <?= csrf_field(); ?>
        ...
        <div class="map-container">
            ...
            <div class="map-sidebar">
                <h4>Dokumentasi Realisasi Aktifitas Kegiatan <br><br><?= esc($nama_opd) ?></h4>
