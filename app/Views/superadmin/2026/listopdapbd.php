                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if (count($da) == 0) {
                                        ...
                                        // if ($croopd < 50) { 
                                        ?>
                                        <!-- <span class="badge text-bg-danger"><?php //esc(number_format($croopd, 2)) 
                                                                                ?>%</span> -->
                                        <?php
                                        // } elseif ($croopd >= 50 && $croopd < 75) { 
                                        ?>
                                        <!-- <span class="badge text-bg-warning"><?php //esc(number_format($croopd, 2)) 
                                                                                    ?>%</span> -->
                                        <?php
                                        // } elseif ($croopd >= 75 && $croopd < 90) { 
                                        ?>
                                        <!-- <span class="badge text-bg-primary"><?php   //esc(number_format($croopd, 2)) 
                                                                                    ?>%</span> -->
                                        <?php
                                        // } else { 
                                        ?>
                                        <!-- <span class="badge text-bg-success"><?php //esc(number_format($croopd, 2)) 
                                                                                    ?>%</span> -->
                                    <?php // }
                                    }
