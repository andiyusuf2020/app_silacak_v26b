    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card-header">
                <p style="text-align:center;">LAPORAN KINERJA PROGRAM KEGIATAN PENDUKUNG PROGRAM TEMATIK PEMBANGUNAN TA
                ...
                <table class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th rowspan="2"><strong>PROGRAM TEMATIK PEMBANGUNAN YANG DIDUKUNG</strong></th>
                    ...
                    <tbody>
                        ...
                        foreach ($progtematik as $key => $dataprogtematik) { ?>
                            <tr>
                                <td>-</td>
                                <td colspan="7">
                                    <?= esc($dataprogtematik['nm_tematik']) ?>
                                </td>
                            </tr>
                            <?php
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4">
                                            ...
                                            <strong>Realisasi di Bulan <?= esc($rkegpokok['bulan'] ?? $bulan) ?></strong><br>
                                    ...
                                    foreach ($dataDRKP as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td colspan="4">
                                                ...
                                                <strong><?= esc($rkegpokok['r_uraian']) ?></strong>
                                                <img src="uploads/dokumentasi/<?= esc($value['gambar'] ?? null) ?>" width="250"><br>
                                                <?= esc($value['deskripsi']) ?>
                                                Lokasi Aktifitas:
