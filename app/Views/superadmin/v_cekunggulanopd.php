    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card-header">
                <p style="text-align:center;">LAPORAN KINERJA PROGRAM KEGIATAN PENDUKUNG PROGRAM UNGGULAN TA
                ...
                <table class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th rowspan="2"><strong>PEMBANGUNAN UNGGULAN YANG DIDUKUNG</strong></th>
                    ...
                    <tbody>
                        ...
                        foreach ($progunggulan as $key => $dataprogunggul) { ?>
                            <tr>
                                <td>-</td>
                                <td colspan="7">
                                    <?= esc($dataprogunggul['nm_progunggulan']) ?>
                                </td>
                            </tr>
                            <?php
