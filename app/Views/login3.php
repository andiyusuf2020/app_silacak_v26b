...
<body class="img js-fullheight" style="background-image: url(<?= base_url() ?>csslogin/bg_login.jpg);">
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 text-center mb-5">
                    ...
                    <img class="img-fluid" style="max-height: 200px;" src="<?php echo base_url('cssportal/img_home'); ?>/logositapis.png" alt data-pagespeed-url-hash="2410369107" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
