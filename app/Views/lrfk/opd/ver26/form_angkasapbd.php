        ...
        <div class="col-6">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Form Input Data Anggaran Kas Sub Kegiatan : <?= esc($datauser['sub_unit']);  ?></h3>
                                        ...
                                        <tbody>
                                            <tr class="align-middle">
                                                ...
                                                <td>
                                                    ...
                                                    <strong>Pagu Rp. <?= esc(number_format($subkegperopd['anggaran'], 2, ',', '.')) ?></strong>
                                                </td>
                                                <td> </td>
                                            </tr>
                                            <?php
                                            ...
                                            ?>
                                                <tr>
                                                    <td>#</td>
                                                    <td><?= esc($bulan['bulan']) ?></td>
                                                    <td>
                                                        <?php
                                                        $realisasi = [
                                                            'type' => 'text',
                                                            'name' => 'dataangkas[' . $key . '][ANGKAS]',
                                                            'value' =>  esc(number_format($dataangkas['ANGKAS'] ?? 0, 0, ',', '.')),
                                                        ...
                                                        echo form_hidden('dataangkas[' . $key . '][Id_angkas]', esc($dataangkas['Id_angkas'] ?? ''));
                                                        echo form_hidden('dataangkas[' . $key . '][TAHUN]', esc($subkegperopd['TAHUN']));
                                                        echo form_hidden('dataangkas[' . $key . '][KODE_UNIT_SKPD]', esc($subkegperopd['KODE_UNIT_SKPD']));
                                                        echo form_hidden('dataangkas[' . $key . '][NAMA_UNIT_SKPD]', esc($subkegperopd['NAMA_UNIT_SKPD']));
                                                        echo form_hidden('dataangkas[' . $key . '][KODE_SUB_GIAT]', esc($subkegperopd['KODE_SUB_GIAT']));
                                                        echo form_hidden('dataangkas[' . $key . '][NAMA_SUB_GIAT]', esc($subkegperopd['NAMA_SUB_GIAT']));
                                                        echo form_hidden('dataangkas[' . $key . '][TOTAL_ANGGARAN]', esc($subkegperopd['anggaran']));
                                                        echo form_hidden('dataangkas[' . $key . '][BULAN_ANGKAS]', esc($bulan['bulan']));
