                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <?php foreach ($subkegbelanja as $key => $rowbelanja) {
                                            ?>
                                                <tr class="align-middle">
                                                    <td><?= esc($key + 1)  ?></td>
                                                    <td><?= esc($rowbelanja['nm_rekening']) ?></td>
                                                    <td><?= esc(number_format($rowbelanja['pagu_rincian'], 2, ',', '.')) ?></td>
                                                    <td>
                                                        <?php
                                                        $rperBel = $this->realisasilrfkrinci->realperSKpeBlnRinci(
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    echo form_hidden('totalpagusubkeg', $totalpagusubkeg);
                                    echo form_hidden('kd_sub_unit', esc($rowbelanja['kd_sub_unit']));
                                    echo form_hidden('sub_unit', esc($rowbelanja['nm_sub_unit']));
                                    echo form_hidden('tahun', esc($tahunaktif));
                                    echo form_hidden('bulan', esc($jadwalaktif['bulan']));
                                    echo form_hidden('kd_subkegiatan', esc($rowbelanja['kd_subkegiatan']));
                                    echo form_hidden('nm_subkegiatan', esc($rowbelanja['nm_subkegiatan']));
        ...
        <div class="col-lg-6">
            <div class="card mb-4">
                ...
                <div class="card-header border-0">
                    ...
                    <br> Total Pagu Subkegiatan :: <?= 'Rp  ' . esc(number_format($totalpagusubkeg, 2, ',', '.')) ?>
                </div>
