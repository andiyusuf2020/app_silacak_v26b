                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <div class="mb-3">
                                ...
                                <?php endif; ?>
                                <label for="basic-url" class="form-label">Perangkat Daerah</label>
                                <div class="input-group">
                                    <select name="sub_unit" class="form-select" id="validationCustom04" required>
                                        <?php
                                        foreach ($listopd as $key => $row) {
                                        ?>
                                            <option value="<?= $row['nm_sub_unit']; ?>"><?= esc($row['nm_sub_unit']); ?></option>
                                        <?php
                                        }
                                ...
                                <div class="form-text" id="basic-addon4">
                                    Pilih Nama Perangkat Daerah Anda </div>
                            </div>
                            <div class="mb-3">
