                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <div class="mb-3">
                                        ...
                                        <?php endif; ?>
                                        <label for="basic-url" class="form-label"><?= esc($datarealisasi['nm_urusan']); ?></label>
                                        <label for="basic-url" class="form-label"><?= esc($datarealisasi['nm_sub_unit']); ?></label>
                                        <label for="basic-url" class="form-label"><?= esc($datarealisasi['nm_program']); ?></label>
                                        <label for="basic-url" class="form-label"><?= 'Kegiatan ' . esc($datarealisasi['nm_kegiatan']); ?></label>
                                        <label for="basic-url" class="form-label"><?= 'SubKegiatan ' . esc($datarealisasi['nm_subkegiatan']); ?></label>
                                    </div>
                                    <div class="mb-3">
                                        <label for="basic-url" class="form-label">Akumuasi Realisasi Anggaran Sampai Bulan <?= $jadwalaktif['bulan']  ?></label>
                                        <br>
                                        <label for="basic-url" class="form-label">
                                            <?= 'Rp  ' . esc(number_format($datarealisasi['pagu_realisasi'], 2, ',', '.'));  ?></label>
                                        <div class="input-group">
                                            ...
                                            <?= '....Perubahan Realisasi Ketikkan...disini...' ?>
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <?php } else { ?>
                                            <img src="../../uploads/lrfkopd/<?= esc($datarealisasi['sub_unit']) . '/' . esc($datarealisasi['dokumentasi']) ?>" width="300">
                                        <?php
                                        }
                                        ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            echo form_hidden('kd_subkegiatan', $datarealisasi['kd_subkegiatan']);
                                            echo form_hidden('kd_sub_unit', $datarealisasi['kd_sub_unit']);
            ...
            <div class="col-lg-6">
                <div class="card mb-4">
                    ...
                    <div class="card-header border-0">
                        <h3 class="card-title">Realisasi Anggara per-Bulan <?= 'SubKegiatan ' . esc($datarealisasi['nm_subkegiatan']); ?> </h3>
                        <br> Total Pagu Subkegiatan :: <?= 'Rp  ' . esc(number_format($datarealisasi['pagu_rincian'], 2, ',', '.')) ?>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td><?php
                                        ...
                                        $datarealisasi1 = $this->realisasilrfk->select('ta_realisasi_lrfk.*,a.*')
                                            ...
                                            ->where('ta_realisasi_lrfk.sub_unit', $datarealisasi['nm_sub_unit'])
                                            ->where('ta_realisasi_lrfk.nm_subkegiatan', $datarealisasi['nm_subkegiatan'])
...
<script>
    ...
    rupiah_2.addEventListener("keyup", function(e) {
        rupiah_2.value = convertRupiah_2(this.value);
    });
    rupiah_2.addEventListener('keydown', function(event) {
        return isNumberKey_2(event);
    });

    function convertRupiah_2(angka, prefix) {
