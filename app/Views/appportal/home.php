...
<head>
    ...
    <title>e-Pengendalian Provinsi Lampung</title>
    <!-- Favicon img -->
    <link rel="shortcut icon" href="https://e-pengendalian-provlampung.com/gratech/images/lampungprov.png">
    <!-- Bootstarp min css -->
    <link rel="stylesheet" href="https://e-pengendalian-provlampung.com/gratech/css/bootstrap.min.css">
    <!-- Mean menu css -->
    <link rel="stylesheet" href="https://e-pengendalian-provlampung.com/gratech/css/meanmenu.css">
    <!-- All min css -->
    <link rel="stylesheet" href="https://e-pengendalian-provlampung.com/gratech/css/all.min.css">
    <!-- Swiper bundle min css -->
    <link rel="stylesheet" href="https://e-pengendalian-provlampung.com/gratech/css/swiper-bundle.min.css">
    <!-- Magnigic popup css -->
    <link rel="stylesheet" href="https://e-pengendalian-provlampung.com/gratech/css/magnific-popup.css">
    <!-- Animate css -->
    <link rel="stylesheet" href="https://e-pengendalian-provlampung.com/gratech/css/animate.css">
    <!-- Nice select css -->
    <link rel="stylesheet" href="https://e-pengendalian-provlampung.com/gratech/css/nice-select.css">
    <!-- Style css -->
    <link rel="stylesheet" href="https://e-pengendalian-provlampung.com/gratech/css/style.css">
    <!-- Style sidebar gawe dewe  -->
    <link href='https://unpkg.com/boxicons@2.1.1/css/boxicons.min.css' rel='stylesheet'>

    <link rel="stylesheet" href="https://e-pengendalian-provlampung.com/gratech/sidebar/style.css">

    <link rel="stylesheet" href="https://e-pengendalian-provlampung.com/assets/daypilot-lite-javascript-2025.1.635/demo/helpers/v2/main.css?v=2025.1.635">
    <style type="text/css">
        html {
...
<body>
    ...
    <div class="header-top d-none d-lg-block">
        <div class="container header__container">
            <div class="header-top-wrp">
                <ul class="info" style="margin-left:64px!important;">
                    <li><svg width="15" height="12" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="mailto:bappeda@lampungprov.go.id" class="ms-1">bappeda@lampungprov.go.id</a>
                    </li>
                    <li class="ms-4"><svg width="16" height="15" viewBox="0 0 16 15" fill="none"
                        ...
                        <a href="tel:+62721486396" class="ms-1">(0721) 486396</a>
                    </li>
                </ul>
                <!--  <ul class="link-info">
    ...
    <header class="header-area">
        <div class="container header__container">
            <div class="header__main" style="margin-left:64px!important;">
                <a href="https://e-pengendalian-provlampung.com/" class="logo">
                    <img src="https://e-pengendalian-provlampung.com/gratech/images/logo/e-pengendalian.svg" alt="logo">
                </a>
                <div class="main-menu">
                    <nav>
                        <ul>
                            <li><a href="https://e-pengendalian-provlampung.com/">Home</a></li>
                            <li><a href="#0" onclick="modal_mlebu();">Modul Utama</a></li>
                            <li><a href="https://e-pengendalian-provlampung.com/berita">Berita</a></li>
                            <li class="has-megamenu">
                                <a href="#0">Link</a>
                                <ul class="sub-menu mega-menu menu-image">
                                    <li>
                                        <div class="image text-center">
                                            <img src="https://e-pengendalian-provlampung.com/gratech/images/menu/home7-image.jpg" alt="web bappeda">
                                            <div class="btn__group">
                                                <a href="https://bappeda.lampungprov.go.id" class="btn-one">Ke Web Bappeda</a>
                                            </div>
                                            <h6 class="text-white">Website Bappeda</h6>
                                        </div>
                                        <div class="image text-center">
                                            <img src="https://e-pengendalian-provlampung.com/gratech/images/menu/home6-image.jpg" alt="web bappeda">
                                            <div class="btn__group">
                                                <a href="https://bappeda.lampungprov.go.id" class="btn-one">Ke Web Lampung Prov</a>
                                            </div>
                                            <h6 class="text-white">Website Provinsi Lampung</h6>
                                        </div>
                                    </li>
                                </ul>
                            </li>
                            <!-- <li>
                                <a href="#0">Link</a>
                                <ul class="sub-menu">
                                    <li><a href="https://bappeda.lampungprov.go.id">Web Bappeda</a></li>
                                    <li><a href="https://lampungprov.go.id">Web Provinsi Lampung</a></li>
                                </ul>
                            </li> -->
                            <li>
                                <a href="#0">Kontak</a>
                                <ul class="sub-menu">
                                    <li><a href="https://e-pengendalian-provlampung.com/dokumen_list/list_opd">List OPD</a></li>
                                    <li><a href="https://e-pengendalian-provlampung.com/dokumen_list/list_admin">List Admin</a></li>
                                </ul>
                            </li>
                            <li class="toggle"><a href="https://e-pengendalian-provlampung.com/login/loginwebcsl">Login</a></li>
                            <li><a href="#0">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
    ...
    <div id="targetElement" class="sidebar-area sidebar__hide">
        ...
        <a href="https://e-pengendalian-provlampung.com/" class="logo mb-40">
            <img src="https://e-pengendalian-provlampung.com/gratech/images/logo/e-pengendalian.svg" alt="logo">
        </a>
        ...
        <ul class="info pt-40">
            <li><i class="fa-solid primary-color fa-location-dot"></i> <a href="https://maps.app.goo.gl/f2eonep6DNwq5q739">peta lokasi</a>
            </li>
            <li class="py-2"><i class="fa-solid primary-color fa-phone-volume"></i> <a href="tel:+62721486396">(0721) 486396</a>
            </li>
            <li><i class="fa-solid primary-color fa-paper-plane"></i> <a href="mailto:bappeda@lampungprov.go.id">bappeda@lampungprov.go.id</a></li>
        </ul>
    ...
    <!-- sidebar templekan dewe start here -->
    <nav class="sidebar locked" style="z-index:999;" id="wadah-sidebar">
        <div class="logo_items flex">
            <span class="nav_image">
                <img src="https://e-pengendalian-provlampung.com/Lampung.png" alt="logo_lampung" />
            </span>
            <span class="logo_name">Lampung</span>
            ...
            <div class="menu_items">
              ...
              <a href="#" class="link flex">
                ...
                <span>Overview</span>
                    ...
                    <li class="item">
                        <a href="#" class="link flex" onclick="bukamodal_kalender();">
                            <i class="bx bx-grid-alt"></i>
                            <span>Jadwal Kegiatan</span>
                        </a>
                    </li>
                    <li class="item">
                        <a href="#" class="link flex" onclick="modal_unduh();">
                            <i class="bx bx-cloud-download"></i>
                            <span>Unduh</span>
                        </a>
                    </li>
                    <li class="item">
                        <a href="https://e-pengendalian-provlampung.com/dokumentasi" class="link flex">
                            <i class="bx bx-folder"></i>
                            <span>Dokumentasi</span>
                        </a>
                    </li>
                    <li class="item">
                        <a href="https://e-pengendalian-provlampung.com/pengaduan/aduan" class="link flex">
                            <i class="bx bxs-magic-wand"></i>
                            <span>Pengaduan</span>
                        </a>
                    </li>
                    <li class="item">
                        <a href="https://e-pengendalian-provlampung.com/testimoni" class="link flex">
    ...
    <!-- sidebar templekan dewe rampung here -->
            ...
            <div class="search-cell">
                <form method="get">
                    <div class="search-field-holder">
                        <input type="search" class="main-search-input" placeholder="Cari...">
                    </div>
                </form>
            </div>
        </div>
    ...
    <main>
        ...
        <section class="banner-area">
            <div class="banner__line">
                <img class="sway__animation" src="https://e-pengendalian-provlampung.com/gratech/images/banner/banner-line.png" alt="shape">
            </div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div data-animation="slideInLeft" data-duration="2s" data-delay=".3s"
                            ...
                            <img src="https://e-pengendalian-provlampung.com/gratech/images/banner/banner-regular-left-shape.png" alt="shape">
                        </div>
                        <div data-animation="slideInLeft" data-duration="2s" data-delay=".9s"
                            class="banner__shape-left1">
                            <img src="https://e-pengendalian-provlampung.com/gratech/images/banner/banner-solid-left-shape.png" alt="shape">
                        </div>
                        <div class="banner__shape-left3 wow slideInLeft">
                            <img class="sway__animation" src="https://e-pengendalian-provlampung.com/gratech/images/banner/banner-shape-left.png" alt="shape">
                        </div>
                        <div class="banner__shape-right2" data-animation="slideInRight" data-duration="3s"
                            data-delay=".3s">
                            <img src="https://e-pengendalian-provlampung.com/gratech/images/banner/banner-shape-right-line.png" alt="shape">
                        </div>
                        <div class="banner__shape-right1" data-animation="slideInRight" data-duration="2s"
                            data-delay=".3s">
                            <img src="https://e-pengendalian-provlampung.com/gratech/images/banner/banner-shape-right.png" alt="shape">
                        </div>
                        <div class="banner__right-line1" data-animation="slideInRight" data-duration="2s"
                            data-delay=".9s">
                            <img src="https://e-pengendalian-provlampung.com/gratech/images/banner/banner-right-line1.png" alt="shape">
                        </div>
                        <div class="banner__right-line2" data-animation="slideInRight" data-duration="2s"
                            data-delay=".7s">
                            <img src="https://e-pengendalian-provlampung.com/gratech/images/banner/banner-right-line2.png" alt="shape">
                        </div>
                        <div class="banner__right-line3" data-animation="slideInRight" data-duration="2s"
                            data-delay=".5s">
                            <img src="https://e-pengendalian-provlampung.com/gratech/images/banner/banner-right-line3.png" alt="shape">
                        </div>
                        <div class="banner__right-line4" data-animation="slideInRight" data-duration="2s"
                            data-delay=".3s">
                            <img src="https://e-pengendalian-provlampung.com/gratech/images/banner/banner-right-line4.png" alt="shape">
                        </div>
                        <div class="slide-bg" data-background="https://e-pengendalian-provlampung.com/uploadFile/slider/Menara-Siger-Lamsel-min.jpg"></div>
                        <div class="container" style="margin-top:-128px!important;">
                            <div class="banner__content">
                                <h4 data-animation="slideInRight" data-duration="2s" data-delay=".3s"
                                    ...
                                    Gedung Simbol dan Lambang Provinsi Lampung
                                </h4>
                                ...
                                <p data-animation="slideInRight" data-duration="2s" data-delay=".7s" class="mt-20">
                                    Menara Siger berupa bangunan berbentuk mahkota terdiri dari
                                    <br>
                                    sembilan rangkaian yang melambangkan sembilan macam bahasa di Lampung
                                </p>
                                <a data-animation="slideInRight" data-duration="2s" data-delay=".9s" href="#0" onclick="modal_mlebu();"
                                    class="btn-one mt-60">masuk Modul Utama<i class="fa-regular fa-arrow-right-long"></i></a>
                                <br>&nbsp;</br>
                                <div class="gradient-bg">
                                    <div class="counter__item wow bounceInUp" data-wow-delay="00ms" data-wow-duration="1000ms" style="padding:32px!important;">
                                        <img src="https://e-pengendalian-provlampung.com/gratech/images/icon/pricing-icon1.png" alt="icon">
                                        <div class="content">
                                            <h4 class="text-white">Reminder :</h4>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="slide-bg" data-background="https://e-pengendalian-provlampung.com/uploadFile/slider/waykambas2-min.jpg"></div>
                        <div class="container" style="margin-top:-128px!important;">
                            <div class="banner__content">
                                <h4 data-animation="slideInRight" data-duration="2s" data-delay=".3s"
                                    class="text-white mb-20">
                                ...
                                <p data-animation="slideInRight" data-duration="2s" data-delay=".7s" class="mt-20">
                                    adalah taman nasional perlindungan gajah
                                    <br>
                                    yang terletak di daerah Lampung tepatnya di Kecamatan Labuhan Ratu, Lampung Timur
                                </p>
                                <a data-animation="slideInRight" data-duration="2s" data-delay=".9s" href="#0" onclick="modal_mlebu();"
                                    class="btn-one mt-60">masuk Modul Utama<i class="fa-regular fa-arrow-right-long"></i></a>
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="slide-bg" data-background="https://e-pengendalian-provlampung.com/uploadFile/slider/kawah_nirwana_Suoh_TNBBS-min.jpg"></div>
                        <div class="container" style="margin-top:-128px!important;">
                            <div class="banner__content">
                                <h4 data-animation="slideInRight" data-duration="2s" data-delay=".3s"
                                    class="text-white mb-20">
                                ...
                                <p data-animation="slideInRight" data-duration="2s" data-delay=".7s" class="mt-20">
                                    Terdapat di Taman Wisata Kawah Bumi
                                    Taman Nasional Bukit Barisan Selatan disebut juga sebagai Kawah Kaldera Gunung Suoh
                                </p>
                                <a data-animation="slideInRight" data-duration="2s" data-delay=".9s" href="#0" onclick="modal_mlebu();"
                                    class="btn-one mt-60">masuk Modul Utama<i class="fa-regular fa-arrow-rigt-long"></i></a>
        ...
        <!-- <section class="about-area sub-bg pt-120">
            <div class="about__shape wow slideInLeft" data-wow-delay="400ms" data-wow-duration="1500ms">
                <img src="https://e-pengendalian-provlampung.com/gratech/images/shape/about-line.png" alt="shape">
            </div>
            <div class="container">
                <div class="row g-4">
        ...
        <!--  <img src="https://e-pengendalian-provlampung.com/gratech/images/about/about-image1.jpg" alt="image"> -->
        <!--     <img src="https://e-pengendalian-provlampung.com/gratech/images/tugu-siger.jpg" alt="lampung">
                            </div>
                            <div class="image sm-image">
                                <div class="video__btn-wrp">
                                    <div class="video-btn video-pulse">
                                        <a class="video-popup" href="https://e-pengendalian-provlampung.com/upload/profile-e-pengendalian-2024.mp4"><i
                                                class="fa-solid fa-play"></i></a>
                                    </div>
                                </div> -->
        <!-- <img src="https://e-pengendalian-provlampung.com/gratech/images/about/about-image2.png" alt="image"> -->
        <!--   <img src="https://e-pengendalian-provlampung.com/assets/img/home_picture.jpg" alt="image">
                            </div>
                            <div class="circle-shape">
                                <img src="https://e-pengendalian-provlampung.com/gratech/images/shape/about-circle.png" alt="shape">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="section-header mb-40">
                            <h5 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <img class="me-1" src="https://e-pengendalian-provlampung.com/gratech/images/icon/section-title.png" alt="icon">
                                tentang e-Pengendalian
                            </h5>
                            <h2 class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">e-Pengendalian berperan sebagai alat bantu bagi pembuat Kebijakan</h2>
                            <p class="wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">Dengan aplikasi e-Pengendalian Provinsi Lampung 
                                akan membantu tim pembuat kebijakan dalam sinkronisasi Kebijakan
                                dari Pemerintah Pusat, Pemerintah Provinsi, hingga ke Pemerintah Daerah Kabupaten / Kota
                               </p>
                        </div>
                        <div class="row g-4 wow fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="col-md-6">
                                ...
                                <div class="about__right-item">
                                    <div class="icon">
                                        <img src="https://e-pengendalian-provlampung.com/gratech/images/icon/about-icon1.png" alt="icon">
                                    </div>
                                    <div class="content">
                                        <h4 class="mb-1">Pemberkasan</h4>
                                        <p>Penyimpanan Dokumen Dokumen Pengendalian di Server</p>
                                    </div>
                                </div>
                                </a>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="about__right-item">
                                    <div class="icon">
                                        <img src="https://e-pengendalian-provlampung.com/gratech/images/icon/about-icon2.png" alt="icon">
                                    </div>
                                    <div class="content">
                                        <h4 class="mb-1">Alur</h4>
                                        <p>Alur Aplikasi Modul Modul e-Pengendalian</p>
                                    </div>
                                </div>
                                </a>
                            </div>
                        ...
                        <div class="about__info mt-50 wow fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <a href="https://e-pengendalian-provlampung.com/dokumen_list/list_admin" class="btn-one">Kontak <i
                                    class="fa-regular fa-arrow-right-long"></i></a>
                            <div class="d-flex gap-2 align-items-center">
                                <img src="https://e-pengendalian-provlampung.com/gratech/images/about/about-info.png" alt="image">
                                <div class="info">
                                    <h5>Instan Sari Amsya</h5>
                                    <span class="sm-font">Administrator</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="d-flex flex-wrap gap-4 align-items-center justify-content-between mb-60">
                    <div class="section-header">
                        <h5 class="wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <img class="me-1" src="https://e-pengendalian-provlampung.com/gratech/images/icon/section-title.png" alt="icon">
                            Milestone e-Pengendalian
                        </h5>
                        <h2 class="wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">Milestone e-Pengendalian Provinsi Lampung</h2>
                    </div>
                    <!-- <a href="" class="btn-one wow fadeInUp" data-wow-delay="200ms"
                        data-wow-duration="1500ms">Lihat Semua
                        Milestone <i class="fa-regular fa-arrow-right-long"></i></a> -->
                </div>
            </div>
            <div class="swiper case__slider">
                <div class="swiper-wrapper">
                    <!--   <div class="swiper-slide">
                        <div class="case__item">
                            <div class="image case__image">
                                <img src="https://e-pengendalian-provlampung.com/gratech/images/case/case-image1.jpg" alt="image">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="case__item">
                            <div class="image case__image">
                                <img src="https://e-pengendalian-provlampung.com/assets/history/h2018.jpg" alt="e-Pengendalian 2018">
                            </div>
                            <div class="case__content">
                                <span class="primary-color sm-font">Aplikasi Pertama e-Pengendalian</span>
                                <h3><a href="" class="text-white primary-hover">2018</a></h3>
                            </div>
                            <a href="#0" class="case__btn">
                                <i class="fa-regular fa-arrow-right"></i>
                            </a>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="case__item">
                            <div class="image case__image">
                                <img src="https://e-pengendalian-provlampung.com/assets/history/h2019.jpg" alt="e-Pengendalian 2019">
                            </div>
                            <div class="case__content">
                                <span class="primary-color sm-font">RPJMD dan RKPD</span>
                                <h3><a href="#0" class="text-white primary-hover">2019</a>
                                </h3>
                            </div>
                            <a href="#0" class="case__btn">
                                <i class="fa-regular fa-arrow-right"></i>
                    ...
                    <div class="swiper-slide">
                        <div class="case__item">
                            <div class="image case__image">
                                <img src="https://e-pengendalian-provlampung.com/assets/history/h2020-min.jpg" alt="e-Pengendalian 2020">
                            </div>
                            <div class="case__content">
                                <span class="primary-color sm-font">update fitur pencermatan</span>
                                <h3><a href="#0" class="text-white primary-hover">2020</a>
                                </h3>
                            </div>
                            <a href="#0" class="case__btn">
                                <i class="fa-regular fa-arrow-right"></i>
                    ...
                    <div class="swiper-slide">
                        <div class="case__item">
                            <div class="image case__image">
                                <img src="https://e-pengendalian-provlampung.com/assets/history/h2021.jpg" alt="e-pengendalian 2021">
                            </div>
                            <div class="case__content">
                                <span class="primary-color sm-font">update fitur fasilitasi RKPD</span>
                                <h3><a href="#0" class="text-white primary-hover">2021</a>
                                </h3>
                            </div>
                            <a href="#0" class="case__btn">
                                <i class="fa-regular fa-arrow-right"></i>
                    ...
                    <div class="swiper-slide">
                        <div class="case__item">
                            <div class="image case__image">
                                <img src="https://e-pengendalian-provlampung.com/assets/history/h2022.jpg" alt="e-pengendalian 2022">
                            </div>
                            <div class="case__content">
                                <span class="primary-color sm-font">Fitur DAK</span>
                                <h3><a href="#0" class="text-white primary-hover">2022</a>
                                </h3>
                            </div>
                            <a href="#0" class="case__btn">
                                <i class="fa-regular fa-arrow-right"></i>
                    ...
                    <div class="swiper-slide">
                        <div class="case__item">
                            <div class="image case__image">
                                <img src="https://e-pengendalian-provlampung.com/assets/history/h2023.jpg" alt="e-Pengendalian 2023">
                            </div>
                            <div class="case__content">
                                <span class="primary-color sm-font">Fitur RPJPD</span>
                                <h3><a href="#0" class="text-white primary-hover">2023</a>
                                </h3>
                            </div>
                            <a href="#0" class="case__btn">
                                <i class="fa-regular fa-arrow-right"></i>
                    ...
                    <div class="swiper-slide">
                        <div class="case__item">
                            <div class="image case__image">
                                <img src="https://e-pengendalian-provlampung.com/assets/history/h2024.jpg" alt="image">
                            </div>
                            <div class="case__content">
                                <span class="primary-color sm-font">Fitur RPD</span>
                                <h3><a href="#0" class="text-white primary-hover">2024</a>
                                </h3>
                            </div>
                            <a href="#0" class="case__btn">
                                <i class="fa-regular fa-arrow-right"></i>
        ...
        <!-- <section class="offer-area secondary-bg pt-120 pb-200">
            <div class="offer__shadow wow fadeIn" data-wow-delay="200ms" data-wow-duration="1500ms">
                <img src="https://e-pengendalian-provlampung.com/gratech/images/shape/offer-shadow-shape.png" alt="shadow">
            </div>
            <div class="offer__shape-left">
                <img class="wow fadeInUpBig" data-wow-delay="400ms" data-wow-duration="1500ms"
                    src="https://e-pengendalian-provlampung.com/gratech/images/shape/offer-bg-shape-left.png" alt="shape">
            </div>
            <div class="offer__shape-right">
                <img class="wow fadeInDownBig" data-wow-delay="400ms" data-wow-duration="1500ms"
                    src="https://e-pengendalian-provlampung.com/gratech/images/shape/offer-bg-shape-right.png" alt="shape">
            </div>
            <div class="container">
                <div class="d-flex gap-4 flex-wrap align-items-center justify-content-between mb-95">
                    <div class="section-header">
                        <h5 class="wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <img class="me-1" src="https://e-pengendalian-provlampung.com/gratech/images/icon/section-title.png" alt="icon">
                            Aplikasi e-Pengendalian
                        </h5>
                        <h2 class="text-white wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">Fitur Fitur Utama <br> e-Pengendalian</h2>
                    </div>
                    <a href="pricing.html" class="btn-one wow fadeInUp" data-wow-delay="200ms"
                        data-wow-duration="1500ms">Selengkapnya <i class="fa-regular fa-arrow-right-long"></i></a>
                </div>
                <div class="row g-4">
                    <div class="col-lg-2 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="00ms"
                        data-wow-duration="1500ms">
                        <a href="https://e-pengendalian-provlampung.com/login/loginrkpd">
                        <div class="offer__item">
                            <div class="shape-top">
                                <img src="https://e-pengendalian-provlampung.com/gratech/images/shape/offter-item-shape-top.png" alt="shape">
                            </div>
                            <div class="shape-bottom">
                                <img src="https://e-pengendalian-provlampung.com/gratech/images/shape/offter-item-shape-bottom.png" alt="shape">
                            </div>
                            ...
                            <h4 class="text-white mt-20">RKPD</h4>
                        </div></a>
                    </div>
                    <div class="col-lg-2 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="100ms"
                        data-wow-duration="1500ms">
                        <a href="https://e-pengendalian-provlampung.com/login/loginrpjmd">
                        <div class="offer__item">
                            <div class="shape-top">
                                <img src="https://e-pengendalian-provlampung.com/gratech/images/shape/offter-item-shape-top.png" alt="shape">
                            </div>
                            ...
                            <h4 class="text-white mt-20">RPJMD</h4>
                        </div>
                        </a>
                    </div>
                    <div class="col-lg-2 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="200ms"
                        data-wow-duration="1500ms">
                        <a href="https://e-pengendalian-provlampung.com/login/loginrpjpd">
                        <div class="offer__item">
                            <div class="shape-top">
                                <img src="https://e-pengendalian-provlampung.com/gratech/images/shape/offter-item-shape-top.png" alt="shape">
                            </div>
                            ...
                            <h4 class="text-white mt-20">RPJPD</h4>
                        </div>
                        </a>
                    </div>
                    <div class="col-lg-2 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="300ms"
                        data-wow-duration="1500ms">
                        <a href="https://e-pengendalian-provlampung.com/login/logindak">
                        <div class="offer__item">
                            <div class="shape-top">
                                <img src="https://e-pengendalian-provlampung.com/gratech/images/shape/offter-item-shape-top.png" alt="shape">
                            </div>
                            ...
                            <h4 class="text-white mt-20">DAK</h4>
                        </div>
                        </a>
                    </div>
                    <div class="col-lg-2 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="400ms"
                        data-wow-duration="1500ms">
                        <a href="https://e-pengendalian-provlampung.com/login/loginrpd">
                        <div class="offer__item">
                            <div class="shape-top">
                                <img src="https://e-pengendalian-provlampung.com/gratech/images/shape/offter-item-shape-top.png" alt="shape">
                            </div>
                            ...
                            <h4 class="text-white mt-20">RPD</h4>
                        </div>
                        </a>
                    </div>
                    <div class="col-lg-2 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="500ms"
                        ...
                        <div class="offer__item">
                            ...
                            <h4 class="text-white mt-20">Tambahan</h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="brand__wrp">
                    <div class="brand__shape">
                        <img src="https://e-pengendalian-provlampung.com/gratech/images/shape/brand-shape.png" alt="">
                    </div>
                    <div class="swiper brand__slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="brand__image image">
                                    <img src="https://e-pengendalian-provlampung.com/gratech/images/brand/brand-image1.png" alt="image" style="height:64px;">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand__image image">
                                    <img src="https://e-pengendalian-provlampung.com/gratech/images/brand/brand-image2.png" alt="image" style="height:64px;">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand__image image">
                                    <img src="https://e-pengendalian-provlampung.com/gratech/images/brand/brand-image3.png" alt="image" style="height:64px;">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand__image image">
                                    <img src="https://e-pengendalian-provlampung.com/gratech/images/brand/brand-image4.png" alt="image" style="height:64px;">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand__image image">
                                    <img src="https://e-pengendalian-provlampung.com/gratech/images/brand/brand-image5.png" alt="image" style="height:64px;">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- <section class="testimonial-area bg-image pt-120 pb-120" data-background="https://e-pengendalian-provlampung.com/gratech/images/bg/testimonial-bg.png">
            <div class="container">
                <div class="row g-4">
                    <div class="col-lg-6 wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="talk-us__item">
                            <div class="section-header mb-30">
                                ...
                                <h2 class="text-white">e-Pengendalian</h2>
                            </div>
                           ...
                           <form action="#">
                                <div class="row g-3">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" id="subject" value="Judul">
                                    </div>
                                    <div class="col-sm-6">
                                        <label for="number">Nomor HP*</label>
                                        <input type="text" id="number" value="+62 8123456789">
                                    </div>
                                    <div class="col-12">
                                        <label for="massage">Pesan*</label>
                                        <textarea id="massage" placeholder="Tulis Pesan Message"></textarea>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-6 ps-2 ps-lg-5">
                        <div class="section-header mb-40">
                            <h5 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <img class="me-1" src="https://e-pengendalian-provlampung.com/gratech/images/icon/section-title.png" alt="icon">
                                Testimonial Aplikasi
                            </h5>
                            <h2 class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Testimoni e-Pengendalian</h2>
                            <p class="wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                                Testimoni dari user pengguna aplikasi e-Pengendalian Provinsi Lampung
                            </p>
                        </div>
                            ...
                            <div class="swiper-wrapper">
                                    ...
                                    <div class="testimonial__item">
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            <img src="https://e-pengendalian-provlampung.com/new/prt_asset/img/Lampung.png" alt="lampung">
                                            <div class="testi-info">
                                                <h4>KABUPATEN MESUJI</h4>
                                                <p>01-07-2022</p>
                                                <div class="star mt-1">
                                        ...
                                        <p class="mt-30">“ Semua form terupload dengan baik dan lancar di aplikasi. Untuk membantu proses Fasilitasi RKPD Perubahan kami agar file file kami diteruskan ke tim pencermat dan segera dicermati. ”</p>
                                    </div>
                                </div>
                                                                <div class="swiper-slide">
                                    <div class="testimonial__item">
                                        ...
                                        <p class="mt-30">“ Sangat membantu dalam memberikan pencermatan. Semua unggahan Kabupaten /  Kota dapat dipreview dengan baik atau diunduh. Lengkap dengan point point nya. Menyimpan pencermatan dapat dengan mengisi form atau mengunggah file. Sangat membantu proses pencermatan kami ”</p>
                                    </div>
                                </div>
                                                                <div class="swiper-slide">
                                    <div class="testimonial__item">
                                        ...
                                        <p class="mt-30">“ Zoom pengendalian membahas fitur ”</p>
                                    </div>
                                </div>
                                                                <div class="swiper-slide">
                                    <div class="testimonial__item">
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            <img src="https://e-pengendalian-provlampung.com/new/prt_asset/img/Lampung.png" alt="lampung">
                                            <div class="testi-info">
                                                <h4>KABUPATEN TULANG BAWANG</h4>
                                                <p>27-01-2023</p>
                                                <div class="star mt-1">
                                                    <i class="fa-sharp fa-solid fa-star"></i>
                                                    <i class="fa-sharp fa-solid fa-star disable"></i>                                                    <i class="fa-sharp fa-solid fa-star disable"></i>                                                    <i class="fa-sharp fa-solid fa-star disable"></i>                                                    <i class="fa-sharp fa-solid fa-star disable"></i>                                                </div>
                                            </div>
                                        </div>
                                        <p class="mt-30">“ e-Pengendalian tidak bisa diakses. Website down.... ”</p>
                                    </div>
                                </div>
                                 -->
        <!--
                                <div class="swiper-slide">
                                    <div class="testimonial__item">
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            <img src="https://e-pengendalian-provlampung.com/gratech/images/testimonial/testimonial-image2.png" alt="image">
                                            <div class="testi-info">
                                                <h4>Alex Rony</h4>
                                                <p>Web Designer</p>
                                                <div class="star mt-1">
        ...
        <!--  <section class="blog-area pt-120 pb-120">
            <div class="container">
                <div class="section-header text-center mb-60">
                    <h5 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <img class="me-1" src="https://e-pengendalian-provlampung.com/gratech/images/icon/section-title.png" alt="icon">
                        Berita e-Pengendalian
                    </h5>
                    <h2 class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Berita
                    </h2>
                </div>
                <div class="row g-4">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="00ms"
                        ...
                        <div class="blog__item">
                            <a href="https://e-pengendalian-provlampung.com/baru/berita/38" class="blog__image d-block image">
                                <img src="https://e-pengendalian-provlampung.com/uploadFile/berita/38_1000152765.jpg" alt="Jadwal Fasilitasi RKPD Murni 2026 Provinsi Lampung">
                                <div class="blog-tag">
                                    <h3 class="text-white">12</h3>
                                    <span class="text-white">Jun</span>
                                </div>
                            </a>
                            <div class="blog__content">
                                <ul class="blog-info pb-20 bor-bottom mb-20">
                                    ...
                                    <li>
                                        ...
                                        <a href="#0">0 Komentar</a>
                                    </li>
                                </ul>
                                <h3><a href="https://e-pengendalian-provlampung.com/baru/berita/38" class="primary-hover">Jadwal Fasilitasi RKPD Murni 2026 Provinsi Lampung</a></h3>
                                <a class="mt-25 read-more-btn" href="https://e-pengendalian-provlampung.com/baru/berita/38">Selengkapnya <i
                                        class="fa-regular fa-arrow-right-long"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="00ms"
                        data-wow-duration="1500ms">
                        <div class="blog__item">
                            <a href="https://e-pengendalian-provlampung.com/baru/berita/16" class="blog__image d-block image">
                                <img src="https://e-pengendalian-provlampung.com/uploadFile/berita/16_fasilitasi-rkpd-perubahan-lampung-2025.jpeg" alt="Jadwal Fasilitasi RKPD Perubahan 2025 Provinsi Lampung">
                                <div class="blog-tag">
                                    <h3 class="text-white">14</h3>
                                    <span class="text-white">May</span>
                                </div>
                            </a>
                            <div class="blog__content">
                                <ul class="blog-info pb-20 bor-bottom mb-20">
                                ...
                                <h3><a href="https://e-pengendalian-provlampung.com/baru/berita/16" class="primary-hover">Jadwal Fasilitasi RKPD Perubahan 2025 Provinsi Lampung</a></h3>
                                <a class="mt-25 read-more-btn" href="https://e-pengendalian-provlampung.com/baru/berita/16">Selengkapnya <i
                                        class="fa-regular fa-arrow-right-long"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="00ms"
                        data-wow-duration="1500ms">
                        <div class="blog__item">
                            <a href="https://e-pengendalian-provlampung.com/baru/berita/15" class="blog__image d-block image">
                                <img src="https://e-pengendalian-provlampung.com/uploadFile/berita/15_jadwal-rpjmd-2025.jpg" alt="Jadwal Konsultasi RPJMD Kab/Kota Tahun 2025 - 2029">
                                <div class="blog-tag">
                            ...
                            <div class="blog__content">
                                ...
                                <h3><a href="https://e-pengendalian-provlampung.com/baru/berita/15" class="primary-hover">Jadwal Konsultasi RPJMD Kab/Kota Tahun 2025 - 2029</a></h3>
                                <a class="mt-25 read-more-btn" href="https://e-pengendalian-provlampung.com/baru/berita/15">Selengkapnya <i
                                        class="fa-regular fa-arrow-right-long"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms"
                        ...
                        <div class="blog__item">
                            <a href="blog-details.html" class="blog__image image d-block">
                                <img src="https://e-pengendalian-provlampung.com/gratech/images/blog/blog-image2.jpg" alt="image">
                                <div class="blog-tag">
                                    <h3 class="text-white">12</h3>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms"
                        ...
                        <div class="blog__item">
                            <a href="blog-details.html" class="blog__image image d-block">
                                <img src="https://e-pengendalian-provlampung.com/gratech/images/blog/blog-image3.jpg" alt="image">
                                <div class="blog-tag">
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="largeModalLabel">Aplikasi Utama e-Pengendalian Lampung</h4>
                        <a href="#0" onclick="modal_metu();"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button></a>
                    </div>
                    <div class="modal-body">

                        <section class="offer-area secondary-bg pt-20 pb-200" style="height:480px;">
                            <div class="offer__shadow wow fadeIn" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <img src="https://e-pengendalian-provlampung.com/gratech/images/shape/offer-shadow-shape.png" alt="shadow">
                            </div>
                            <div class="offer__shape-left">
                            ...
                            <div class="container">
                                <div class="d-flex gap-4 flex-wrap align-items-center justify-content-between mb-55">
                                    <div class="section-header">
                                        <h5 class="wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                                            <img class="me-1" src="https://e-pengendalian-provlampung.com/gratech/images/icon/section-title.png" alt="icon">
                                            Aplikasi e-Pengendalian
                                        </h5>
                                        <h2 class="text-white wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">Aplikasi Utama <br> e-Pengendalian</h2>
                                    </div>
                                    <!--    <a href="pricing.html" class="btn-one wow fadeInUp" data-wow-delay="200ms"
                        data-wow-duration="1500ms">Selengkapnya <i class="fa-regular fa-arrow-right-long"></i></a> -->
                                </div>
                                <div class="row g-4">
                                    ...
                                    <div class="col-lg-2 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="500ms"
                                        data-wow-duration="1500ms">
                                        <a href="https://e-pengendalian-provlampung.com/login/loginwebcsl">
                                            <div class="offer__item">
                                                <div class="shape-top">
                                                    <img src="https://e-pengendalian-provlampung.com/gratech/images/shape/offter-item-shape-top.png" alt="shape">
                                                </div>
                                                ...
                                                <h4 class="text-white mt-20">Konsol</h4>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <!-- <section class="service-area pt-0 pb-0" style="z-index:9999999898;">
            <div class="service__shape wow slideInRight">
                <img class="sway_Y__animation" src="https://e-pengendalian-provlampung.com/gratech/images/shape/service-bg-shape.png" alt="shape">
            </div>
            <div class="container">
                <div class="d-flex flex-wrap gap-4 align-items-center justify-content-between mb-60">
                    <div class="section-header">
                        <h5 class="wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <img class="me-1" src="https://e-pengendalian-provlampung.com/gratech/images/icon/section-title.png" alt="icon">
                            Modul modul e-Pengendalian
                        </h5>
                        <h2 class="wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">Aplikasi Aplikasi Utama e-Pengendalian <a href="#" onclick="modale_mudun(event);"><button class="arry-next active" style="align:left;"><i
                        class="fa-light fa-chevron-down"></i></button></a></h2>
                    </div>
                </div>
                <div class="row g-4">
                    ...
                    <a href="https://e-pengendalian-provlampung.com/login/loginrkpd">
                        <div class="service__item">
                            <div class="service-shape">
                                <img src="https://e-pengendalian-provlampung.com/gratech/images/shape/service-item-shape.png" alt="shape">
                            </div>
                            <div class="service__icon">
                                <img src="https://e-pengendalian-provlampung.com/app-assets/images/icon/RKPD-min.png" alt="rkpd" style="width:96px;">
                            </div>
                            <h4>RKPD</h4>
                            <p>Di dalam aplikasi Rencana Kerja Perangkat Daerah sistem e-Pengendalian terdapat dua modul, yaitu Fasilitasi RKPD Murni dan RKPD Perubahan</p>
                        </div>
                    </a>
                    </div>
                    ...
                    <a href="https://e-pengendalian-provlampung.com/login/loginrpjmd">
                        <div class="service__item active">
                            ...
                            <div class="service__icon">
                                <img src="https://e-pengendalian-provlampung.com/app-assets/images/icon/RPJMD-min.png" alt="rpjmd" style="width:96px;">
                            </div>
                            <h4>RPJMD</h4>
                            <p>Di dalam modul modul Rencana Pembangunan Jangka Menengah Daerah e-Pengendalian terdapat dua Modul yaitu Konsultasi Rancangan Awal RPJMD dan Evaluasi RPJMD</p>
                        </div>
                    </a>
                    </div>
                    ...
                    <a href="https://e-pengendalian-provlampung.com/login/loginrpjpd">
                        <div class="service__item">
                            ...
                            <div class="service__icon">
                                <img src="https://e-pengendalian-provlampung.com/app-assets/images/icon/RPJPD-min.png" alt="rpjpd" style="width:96px;">
                            </div>
                            <h4>RPJPD</h4>
                            <p>Di dalam modul Rencanan Pembangunan Jangka Panjang Daerah aplikasi e-Pengendalian terdapat dua modul, yaitu Konsultasi RPJPD Kabupaten / Kota dan Evaluasi RPJPD Kabupaten / kota</p>
                        </div>
                    </a>
                    </div>
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="00ms" data-wow-duration="1000ms">
                    <a href="https://e-pengendalian-provlampung.com/login/loginrpd">
                        <div class="service__item">
                            ...
                            <div class="service__icon">
                                <img src="https://e-pengendalian-provlampung.com/app-assets/images/icon/RPD-min.png" alt="rpd" style="width:96px;">
                            </div>
                            <h4>RPD</h4>
                            <p>Di dalam aplikasi Rencana Pembangunan sistem e-Pengendalian terdapat poin poin pengungghan dokumen RPD Kabupaten kota berdasar periode tahun yang dipilih, Penerusan dan Verifikasi Admin, dan Pencermatan Tim Pencermat </p>
                        </div>
                    </a>
                    </div>
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="200ms" data-wow-duration="1000ms">
                    <a href="https://e-pengendalian-provlampung.com/login/logindak">
                        <div class="service__item active">
                            ...
                            <div class="service__icon">
                                <img src="https://e-pengendalian-provlampung.com/app-assets/images/icon/DAK-min.png" alt="dak" style="width:96px;">
                            </div>
                            <h4>DAK</h4>
                            <p>Di dalam modul modul Dana Alokasi Khusus e-Pengendalian terdapat modul pengunggahan dokumen DAK Triwulan berdasarkan Tahun DAK</p>
                        </div>
                    </a>
                    </div>
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
                    <a href="https://e-pengendalian-provlampung.com/dokumentasi">
                        <div class="service__item">
                            <div class="service-shape">
                                <img src="https://e-pengendalian-provlampung.com/gratech/images/shape/service-item-shape.png" alt="shape">
                            </div>
                            <div class="service__icon">
                                <img src="https://e-pengendalian-provlampung.com/app-assets/images/icon/Dokumentasi-min.png" alt="modul" style="width:96px;">
                            </div>
                            <h4>Dokumentasi</a></h4>
                            <p>Modul aplikasi e-Pengendalian berupa Dokumentasi Kegiatan</p>
                        </div>
                    </a>
                    </div>
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
                    <a href="https://e-pengendalian-provlampung.com/login/loginwebcsl">
                        <div class="service__item">
                            ...
                            <div class="service__icon">
                                <img src="https://e-pengendalian-provlampung.com/app-assets/images/icon/Manajemen-Berita-min.png" alt="modul" style="width:96px;">
                            </div>
                            <h4>Berita</h4>
                            <p>Modul berita adalah modul tambahan yang berisi berita dan informasi Seputar e-Pengendalian</p>
                        </div>
                    </a>
                    </div>
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
                    <a href="https://e-pengendalian-provlampung.com/beritanew/galerilihat">
                        <div class="service__item">
                            <div class="service-shape">
                              <img src="https://e-pengendalian-provlampung.com/gratech/images/shape/service-item-shape.png" alt="shape">
                            </div>
                            <div class="service__icon">
                                <img src="https://e-pengendalian-provlampung.com/app-assets/images/icon/Galeri-min.png" alt="modul" style="width:96px;">
                            </div>
                            <h4>Galeri</h4>
                            <p>Modul tambahan galeri berisi gambar dan video seputar e-Pengendalian</p>
                        </div>
                    </a>
                    </div>
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
                    <a href="https://e-pengendalian-provlampung.com/pengaduan/aduan">
                        <div class="service__item">
                            <div class="service-shape">
                              <img src="https://e-pengendalian-provlampung.com/gratech/images/shape/service-item-shape.png" alt="shape">
                            </div>
                            <div class="service__icon">
                                <img src="https://e-pengendalian-provlampung.com/app-assets/images/icon/Pengaduan-min.png" alt="modul" style="width:96px;">
                            </div>
                            <h4>Pengaduan</h4>
                            <p>Modul tambahan pengaduan berisi pengaduan seputar aplikasi e-Pengendalian</p>
                        </div>
                    </a>
                    </div>
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
                    <a href="https://e-pengendalian-provlampung.com/testimoni">
                        <div class="service__item">
                            <div class="service-shape">
                              <img src="https://e-pengendalian-provlampung.com/gratech/images/shape/service-item-shape.png" alt="shape">
                            </div>
                            <div class="service__icon">
                                <img src="https://e-pengendalian-provlampung.com/app-assets/images/icon/Testimoni-min.png" alt="modul" style="width:96px;">
                            </div>
                            <h4>Testimoni</h4>
                            <p>Modul tambahan pengaduan berisi testimonial penggunaan Aplikasi e-Pengendalian dari user user pengguna Aplikasi </p>
                        </div>
                    </a>
                    </div>
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
                            <br>&nbsp;</br>
                            <br>&nbsp;</br>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="modale_munggah(event);"><button class="arry-next active" style="align:left;"><i
                        class="fa-light fa-chevron-up"></i></button></a>
                        </div>
                </div>
            </div>
        </section> -->
                    ...
                    <div class="modal-footer">
                        <a href="#0" onclick="modal_metu();"><button type="button" class="btn btn-light" data-dismiss="modal">Tutup</button></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="modal_unduh" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xxl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Unduhan e-Pengendalian Lampung&nbsp;<a href="#" onclick="modale_mudun(event);"><button class="arry-next active" style="align:left;"><i
                                        class="fa-light fa-chevron-down"></i></button></a></h4>
                        <a href="#0" onclick="modal_metu_unduh();"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button></a>
                    </div>
                    <div class="modal-body" id="isimodal_app" style="overflow-y: scroll;height:576px;">
                            ...
                            <div class="container">
                                <div class="counter__wrp gradient-bg">
                                    <div class="counter__shape wow slideInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
                                        <img src="https://e-pengendalian-provlampung.com/gratech/images/shape/counnter-bg-shape.png" alt="shape">
                                    </div>
                                    <div class="counter__item wow bounceInUp" data-wow-delay="00ms" data-wow-duration="1000ms">
                                        <img src="https://e-pengendalian-provlampung.com/gratech/images/icon/counter-icon1.png" alt="icon">
                                        <div class="content">
                                            <!-- <a href="" target="_blank"><h3><span class="count">Unduh</span>+</h3></a> -->
                                            <a href="https://e-pengendalian-provlampung.com/uploadFile/SOP.pdf" target="_blank">
                                                <h3>Unduh <span><i class="fa-regular fa-arrow-down-long"></i></span></h3>
                                            </a>
                                            <p class="text-white">SOP</p>
                                        </div>
                                    </div>
                                    <div class="counter__item wow bounceInUp" data-wow-delay="200ms" data-wow-duration="1000ms">
                                        <img src="https://e-pengendalian-provlampung.com/gratech/images/icon/counter-icon2.png" alt="icon">
                                        <div class="content">
                                            <a href="https://e-pengendalian-provlampung.com/uploadFile/manual.docx" target="_blank">
                                                <h3>Unduh <span><i class="fa-regular fa-arrow-down-long"></i></span></h3>
                                            </a>
                                            <p class="text-white">Manual RPJMD RKPD</p>
                                        </div>
                                    </div>
                                    <div class="counter__item wow bounceInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
                                        <img src="https://e-pengendalian-provlampung.com/gratech/images/icon/counter-icon3.png" alt="icon">
                                        <div class="content">
                                            <a href="https://e-pengendalian-provlampung.com/uploadFile/Tutorial_Dak_v1.docx" target="_blank">
                                                <h3>Unduh <span><i class="fa-regular fa-arrow-down-long"></i></span></h3>
                                            </a>
                                            <p class="text-white">Tutorial DAK</p>
                                        </div>
                                    </div>
                                    <div class="counter__item wow bounceInUp" data-wow-delay="800ms" data-wow-duration="1000ms">
                                        <img src="https://e-pengendalian-provlampung.com/gratech/images/icon/counter-icon4.png" alt="icon">
                                        <div class="content">
                                            <a href="https://e-pengendalian-provlampung.com/uploadFile/Tutorial_RPJPD_v1.pdf" target="_blank">
                                                <h3>Unduh <span><i class="fa-regular fa-arrow-down-long"></i></span></h3>
                                            </a>
                                            <p class="text-white">Tutorial RPJPD</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <section class="process-area pt-30 pb-120">
                            <div class="container">
                                <div class="section-header text-center mb-60">
                                    <h5 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                                        <img class="me-1" src="https://e-pengendalian-provlampung.com/gratech/images/icon/section-title.png" alt="icon">
                                    ...
                                    <h2 class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Alur Kerja Konsultasi RPJMD
                                    </h2>
                                </div>
                                <div class="row g-4">
                                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                                        <div class="process__item mb-100">
                                            <div class="process-arry bobble__animation">
                                                <img src="https://e-pengendalian-provlampung.com/gratech/images/process/process-arry.png" alt="arry-icon">
                                            </div>
                                            <div class="process__image">
                                                <img src="https://e-pengendalian-provlampung.com/gratech/images/process/process-image1.png" alt="image">
                                                <span class="process-number">1</span>
                                            </div>
                                            <div class="process__content">
                                                <h4 class="mt-25 mb-10">
                                                    Pengunggahan Dokumen Konsultasi
                                                </h4>
                                                <p>User Kabupaten / Kota melakukan proses pengunggahan dokumen konsultasi RPJMD
                                                    sesuai dengan poin poin yang sudah ditentukan
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                                        <div class="process__item mb-100">
                                            ...
                                            <div class="process__image">
                                                <img src="https://e-pengendalian-provlampung.com/gratech/images/process/process-image2.png" alt="image">
                                            ...
                                            <div class="process__content">
                                                ...
                                                <p>Admin melakukan verifikasi kelengkapan dan kesesuaian berkas Kunsultasi RPJMD Kabupaten / Kota
                                                    Selanjutnya meneruskan dokumen dan membuka akses pencermatan oleh tim pencermat
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                                        <div class="process__item">
                                            <div class="process__image">
                                                <img src="https://e-pengendalian-provlampung.com/gratech/images/process/process-image3.png" alt="image">
                                            ...
                                            <div class="process__content">
                                                ...
                                                <p>Tim pencermat yang sudah dipilih Admin mencermati poin poin dokumen unggahan Kabupaten / Kota
                                                    yang sudah diteruskan Admin Ke Tim Pencermat Tersebut, selanjutnya direkap oleh Admin dan Admin membuat Hasil Konsultasi dan berita Acara Konsultasi</p>
                                            </div>
                                        </div>
                                    </div>
                                    <canter><a href="#" onclick="modale_munggah(event);" style="align:left;pading-left:33%!important;"><button class="arry-next active"><i class="fa-light fa-chevron-up"></i></button></a></center>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        <a href="#0" onclick="modal_metu_unduh();"><button type="button" class="btn btn-light" data-dismiss="modal">Tutup</button></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="modal_kalender" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="largeModalLabel">Jadwal e-Pengendalian Aug 2025</h4>
                        <a href="#0" onclick="tutupmodal_kalender();"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button></a>
                    </div>
                    <div class="modal-body">
                        ...
                        <section class="service-area pt-0 pb-0" style="z-index:9999999898;">
                            ...
                            <div class="container">
                                <div class="d-flex flex-wrap gap-4 align-items-center justify-content-between mb-10">
                                    <div class="section-header">
                                        <h5 class="wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                                            <img class="me-1" src="https://e-pengendalian-provlampung.com/gratech/images/icon/section-title.png" alt="icon">
                                            Klik kotak tanggal untuk detail
                                        </h5>
                                        <!-- <h2 class="wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">Jadwal Kegiatan e-Pengendalian <a href="#" onclick="modale_mudun(event);"><button class="arry-next active" style="align:left;"><i
                        class="fa-light fa-chevron-down"></i></button></a></h2> -->
                                    </div>
                                    <!-- <a href="" class="btn-one wow fadeInUp" data-wow-delay="200ms"
                        data-wow-duration="1500ms">Tampilkan Semua
                        Services <i class="fa-regular fa-arrow-right-long"></i></a> -->
                                </div>
                                <div>
                                    <div id="keterangantgl"></div>
                                    <div id="dp"></div>
                                    <!-- <iframe src="https://calendar.google.com/calendar/embed?src=cvindojayaweb%40gmail.com&ctz=Asia%2FJakarta" style="border: 0" width="800" height="600" frameborder="0" scrolling="no"></iframe> -->
                                </div>
                            </div>
                        </section>
                        <!-- Service area end here -->
                    ...
                    <div class="modal-footer">
                        <a href="#0" onclick="tutupmodal_kalender();"><button type="button" class="btn btn-light" data-dismiss="modal">Tutup</button></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <section class="quote-area">
            <div class="container">
                <div class="counter__wrp gradient-bg" style="padding: 60px; z-index: 1; margin-top: 0; margin-bottom: -72px;">
                    <div class="counter__shape wow slideInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <img src="https://e-pengendalian-provlampung.com/gratech/images/shape/counnter-bg-shape.png" alt="shape">
                    </div>
                    <div class="counter__item wow bounceInUp" data-wow-delay="00ms" data-wow-duration="1000ms">
                        <img src="https://e-pengendalian-provlampung.com/gratech/images/icon/counter-icon1.png" alt="icon">
                        <div class="content">
                            <h3><span class="count" id="lagi_onlen">6,561</span>+</h3>
                    ...
                    <div class="counter__item wow bounceInUp" data-wow-delay="200ms" data-wow-duration="1000ms">
                        <img src="https://e-pengendalian-provlampung.com/gratech/images/icon/counter-icon2.png" alt="icon">
                        <div class="content">
                            <h3><span class="count" id="onlen_dino_iki">600</span>+</h3>
                    ...
                    <div class="counter__item wow bounceInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
                        <img src="https://e-pengendalian-provlampung.com/gratech/images/icon/counter-icon3.png" alt="icon">
                        <div class="content">
                            <h3><span class="count" id="totalan_akses">250</span>+</h3>
                            <p class="text-white">30 Hari</p>
                        </div>
                    </div>
                    <div class="counter__item wow bounceInUp" data-wow-delay="800ms" data-wow-duration="1000ms">
                        <img src="https://e-pengendalian-provlampung.com/gratech/images/icon/counter-icon4.png" alt="icon">
                        <div class="content">
                            <h3><span class="count" id="totalan_unik">590</span>+</h3>
    ...
    <footer class="footer-area secondary-bg">
        <div class="footer__shape-regular-left wow slideInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
            <img src="https://e-pengendalian-provlampung.com/gratech/images/shape/footer-regular-left.png" alt="shape">
        </div>
        <div class="footer__shape-solid-left wow slideInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
            <img class="sway_Y__animation" src="https://e-pengendalian-provlampung.com/gratech/images/shape/footer-solid-left.png" alt="shape">
        </div>
        <div class="footer__shape-solid-right wow slideInRight" data-wow-delay="00ms" data-wow-duration="1500ms">
            <img class="sway_Y__animation" src="https://e-pengendalian-provlampung.com/gratech/images/shape/footer-regular-right.png" alt="shape">
        </div>
        <div class="footer__shape-regular-right wow slideInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
            <img src="https://e-pengendalian-provlampung.com/gratech/images/shape/footer-solid-right.png" alt="shape">
        </div>
        <div class="footer__shadow-shape">
            <img src="https://e-pengendalian-provlampung.com/gratech/images/shape/footer-shadow-shape.png" alt="shodow">
        </div>
        <div class="container" style="height:320px;">
            <div class="footer__wrp pt-100 pb-100">
                <div class="footer__item item-big wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                    <a href="https://e-pengendalian-provlampung.com/" class="logo mb-30">
                        <img src="https://e-pengendalian-provlampung.com/gratech/images/logo/tentang-e-pengendalian.png" alt="image" style="margin-bottom:-96px!important;">
                    </a></br>
                    <p>Aplikasi untuk membantu sinkronisasi Kebijakan dari Pemerintah Pusat, Pemerintah Provinsi, hingga Pemerintah Daerah Kabupaten / Kota</p></br>
                    <!-- <ul class="footer-contact">
                        <li>
                            <div class="info">
                                        ...
                                        <p>--><!-- Website  : --><!--<a href="https://bappeda.lampungprov.go.id">bappeda.lampungprov.go.id</a></p>
                        <!--    </div>
                        </li>
                    </ul> -->
                ...
                <div class="footer__item item-sm wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3971.9299254826615!2d105.2488870146819!3d-5.427616496063583!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e40da477cf50377%3A0x59404065ad0c1575!2sBappeda%20Lampung%20Province!5e0!3m2!1sen!2sid!4v1653872447699!5m2!1sen!2sid" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
                <div class="footer__item item-sm wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <h3 class="footer-title">Alamat</h3>
                    <p class="mb-20">Jl. Wolter Monginsidi No.223 Teluk Betung-Bandar Lampung</p>
                    <ul class="footer-contact">
                        <!-- <li>
                            <div class="info">
                                        <!-- <h5>
                        ...
                        <li>
                            <div class="info">
                                ...
                                <p><!-- Email    : --><a href="mailto:bappeda@lampungprov.go.id">bappeda@lampungprov.go.id</a></a></p>
                            </div>
                        </li>
                    </ul>
                </div>
                <div class="footer__item item-big wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <h3 class="footer-title">Layanan Bappeda</h3>
        ...
        <div class="footer__copyright">
            <div class="container">
                <div
                    ...
                    <p class="wow fadeInDown" data-wow-delay="00ms" data-wow-duration="1500ms">&copy; Copyright 2018 - 2024
                        <a href="https://bappeda.lampungprov.go.id">Bappeda Provinsi Lampung</a>
                    </p>
                    <ul class="d-flex align-items-center gap-4 wow fadeInDown" data-wow-delay="200ms"
                        data-wow-duration="1500ms">
                        <li><a href="https://e-pengendalian-provlampung.com/baru/terms_and_conditions">Terms & Condition</a></li>
                        <li><a href="https://e-pengendalian-provlampung.com/baru/privacy_policy">Privacy Policy</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="scroll-up munggah" style="margin-bottom:55px!important;">
        <svg class="scroll-circle svg-content" width="100%" height="100%" viewBox="-1 -1 102 102">
            <path d="M50,1 a49,49 0 0,1 0,98 a49,49 0 0,1 0,-98" />
        </svg>
    </div>
    <div class="scroll-up mudun" style="transform: rotate(-180deg)!important;">
        <svg class="scroll-circle svg-content" width="100%" height="100%" viewBox="-1 -1 102 102">
            <path d="M50,1 a49,49 0 0,1 0,98 a49,49 0 0,1 0,-98" />
        </svg>
    </div>
    ...
    <!-- Jquery 3.7.0 Min Js -->
    <script src="https://e-pengendalian-provlampung.com/gratech/js/jquery-3.7.1.min.js"></script>
    <!-- Bootstrap min Js -->
    <script src="https://e-pengendalian-provlampung.com/gratech/js/bootstrap.min.js"></script>
    <!-- Mean menu Js -->
    <script src="https://e-pengendalian-provlampung.com/gratech/js/meanmenu.js"></script>
    <!-- Swiper bundle min Js -->
    <script src="https://e-pengendalian-provlampung.com/gratech/js/swiper-bundle.min.js"></script>
    <!-- Counterup min Js -->
    <script src="https://e-pengendalian-provlampung.com/gratech/js/jquery.counterup.min.js"></script>
    <!-- Wow min Js -->
    <script src="https://e-pengendalian-provlampung.com/gratech/js/wow.min.js"></script>
    <!-- Pace min Js -->
    <script src="https://e-pengendalian-provlampung.com/gratech/js/pace.min.js"></script>
    <!-- Magnific popup min Js -->
    <script src="https://e-pengendalian-provlampung.com/gratech/js/magnific-popup.min.js"></script>
    <!-- Nice select min Js -->
    <script src="https://e-pengendalian-provlampung.com/gratech/js/nice-select.min.js"></script>
    <!-- Isotope pkgd min Js -->
    <script src="https://e-pengendalian-provlampung.com/gratech/js/isotope.pkgd.min.js"></script>
    <!-- Waypoints Js -->
    <script src="https://e-pengendalian-provlampung.com/gratech/js/jquery.waypoints.js"></script>

    <script src="https://e-pengendalian-provlampung.com/assets/daypilot-lite-javascript-2025.1.635/demo/js/daypilot-all.min.js?v=2025.1.635"></script>

    <script src="https://e-pengendalian-provlampung.com/assets/daypilot-lite-javascript-2025.1.635/demo/helpers/v2/app.js?v=2025.1.635"></script>
    <!-- Script Js -->
    <script>
        function modale_mudun(e) {
            e.preventDefault();
            $("#isimodal_app").animate({
                scrollTop: $("#isimodal_app").height() + 576
            }, "slow");
        }

        function modale_munggah(e) {
            e.preventDefault();
            $("#isimodal_app").animate({
                scrollTop: 0
            }, "slow");
        ...
        function modal_unduh() {
            //	e.preventDefault();
            $('#modal_unduh').modal('show');
        }

        function modal_metu_unduh() {
            //	e.preventDefault();
            $('#modal_unduh').modal('hide');
        }

        function bukamodal_kalender() {
            $('#modal_kalender').modal('show');
        }

        function tutupmodal_kalender() {
            $('#modal_kalender').modal('hide');
        }
        ...
        //     s1.async = true;
        //     s1.src = 'https://embed.tawk.to/6799e71d825083258e0ce882/1iioitjmo';
        //     s1.charset = 'UTF-8';
        ...
        function load_itungan() {
            url_lagi_onlen = 'https://e-pengendalian-provlampung.com/baru/load_onlen';
            url_onlen_dino_iki = 'https://e-pengendalian-provlampung.com/baru/load_onlen_dino_iki';
            url_totalan_akses = 'https://e-pengendalian-provlampung.com/baru/load_totalan_akses';
            url_totalan_unik = 'https://e-pengendalian-provlampung.com/baru/load_totalan_unik';
            $('#lagi_onlen').load(url_lagi_onlen);
            $('#onlen_dino_iki').load(url_onlen_dino_iki);
            $('#totalan_akses').load(url_totalan_akses);
            $('#totalan_unik').load(url_totalan_unik);
            tid = setTimeout(load_itungan, 2000);
            //  alert('Function not loaded, security issues 483...'+url_lagi_onlen+'/'+url_onlen_dino_iki+'/'+url_totalan_akses+'/'+url_totalan_unik);
        }
        ...
        if (window.location.search == "?bukain") {
            setTimeout(function() {
                $('#largeModal').modal('show');
            }, 3000);
        }
        ...
        function bukalender(tanggal) {
            // tanggalan = tanggal.substring(0, 3);
            url = 'https://e-pengendalian-provlampung.com/baru/get_tanggal/' + tanggal;
            $('#keterangantgl').load(url);
            //alert(tanggal);
        }
        ...
        const dp = new DayPilot.Month("dp", {
            ...
            onTimeRangeSelected: async function(args) {
                ...
                // });
                bukalender(args.start);
                // alert(args.end);
                // alert(DayPilot.guid());
            },
            onEventClicked: async function(args) {
                bukalender(args.e.data.start);
                // $.each( args, function( key, value ) {
                // 	alert( key + ": " + value );
                // 		$.each( value, function( kunci, nilai ) {
                // 			alert( key + ": " + kunci + ": " + nilai );
                // 				$.each( nilai, function( kencur, biji ) {
                // 					alert( key + ": " + kunci + ": " + kencur + ": " + biji );
                // 				});
                // 		});
                // 	});
            },
        ...
        //     dp.events.add({
        //         start: new DayPilot.Date("2025-04-04T00:00:00").addDays(start),
        //         end: new DayPilot.Date("2025-04-04T12:00:00").addDays(start).addDays(duration),
        //         id: DayPilot.guid(),
        //         text: "Event " + i
        //     });
        // }
        ...
        // dp.events.add({
        //      start: new DayPilot.Date("2025-04-15T07:30:00").addDays(0),
        //      end: new DayPilot.Date("2025-04-15T07:30:00").addDays(0).addDays(0),
        //      id: DayPilot.guid(),
        //      text: "Batas Upload"
        //  });

        //  dp.events.add({
        //      start: new DayPilot.Date("2025-04-18T07:30:00").addDays(0),
        //      end: new DayPilot.Date("2025-04-18T07:30:00").addDays(0).addDays(0),
        //      id: DayPilot.guid(),
        //      text: "Batas Upload"
        //  });

        //  dp.events.add({
        //      start: new DayPilot.Date("2025-04-21T09:00:00").addDays(0),
        //      end: new DayPilot.Date("2025-04-22T15:30:00").addDays(0).addDays(0),
        //      id: DayPilot.guid(),
        //      text: "Konsultasi RPJMD"
        //  });

        //  dp.events.add({
        //      start: new DayPilot.Date("2025-04-24T09:00:00").addDays(0),
        //      end: new DayPilot.Date("2025-04-25T15:30:00").addDays(0).addDays(0),
        //      id: DayPilot.guid(),
        //      text: "Konsultasi RPJMD"
        //  });

        //  dp.events.add({
        //      start: new DayPilot.Date("2025-04-28T09:00:00").addDays(0),
        //      end: new DayPilot.Date("2025-04-30T15:30:00").addDays(0).addDays(0),
        //      id: DayPilot.guid(),
        //      text: "Konsultasi RPJMD"
        //  });

        dp.events.add({
            start: new DayPilot.Date("2025-04-15T09:00:00").addDays(0),
            end: new DayPilot.Date("2025-04-15T09:00:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Way Kanan"
        });
        ...
        dp.events.add({
            start: new DayPilot.Date("2025-04-18T09:00:00").addDays(0),
            end: new DayPilot.Date("2025-04-18T09:00:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Balam"
        });
        ...
        dp.events.add({
            start: new DayPilot.Date("2025-04-21T09:00:00").addDays(0),
            end: new DayPilot.Date("2025-04-21T11:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Way Kanan"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-04-21T13:00:00").addDays(0),
            end: new DayPilot.Date("2025-04-21T15:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Lambar"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-04-22T09:00:00").addDays(0),
            end: new DayPilot.Date("2025-04-22T11:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Pesisir Barat"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-04-22T13:00:00").addDays(0),
            end: new DayPilot.Date("2025-04-22T15:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Metro"
        });
        ...
        dp.events.add({
            start: new DayPilot.Date("2025-04-24T09:00:00").addDays(0),
            end: new DayPilot.Date("2025-04-24T11:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Tubaba"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-04-24T13:00:00").addDays(0),
            end: new DayPilot.Date("2025-04-24T15:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Mesuji"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-04-25T09:00:00").addDays(0),
            end: new DayPilot.Date("2025-04-25T11:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Tulangbawang"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-04-25T13:00:00").addDays(0),
            end: new DayPilot.Date("2025-04-25T15:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Pringsewu"
        });
        ...
        dp.events.add({
            start: new DayPilot.Date("2025-04-28T09:00:00").addDays(0),
            end: new DayPilot.Date("2025-04-28T11:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Balam"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-04-28T13:00:00").addDays(0),
            end: new DayPilot.Date("2025-04-28T15:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Lamut"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-04-29T09:00:00").addDays(0),
            end: new DayPilot.Date("2025-04-29T11:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Lamsel"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-04-29T13:00:00").addDays(0),
            end: new DayPilot.Date("2025-04-29T15:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Lamtim"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-04-30T09:00:00").addDays(0),
            end: new DayPilot.Date("2025-04-30T11:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Lamteng"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-04-30T13:00:00").addDays(0),
            end: new DayPilot.Date("2025-04-30T15:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Tanggamus"
        });
        ...
        dp.events.add({
            start: new DayPilot.Date("2025-05-23T08:00:00").addDays(0),
            end: new DayPilot.Date("2025-05-23T10:00:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Lamtim"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-05-23T10:00:00").addDays(0),
            end: new DayPilot.Date("2025-05-23T11:45:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Pesibar"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-05-23T13:30:00").addDays(0),
            end: new DayPilot.Date("2025-05-23T15:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Tanggamus"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-05-26T08:30:00").addDays(0),
            end: new DayPilot.Date("2025-05-26T10:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Lamsel"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-05-26T10:45:00").addDays(0),
            end: new DayPilot.Date("2025-05-26T12:45:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Tubaba"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-05-26T13:30:00").addDays(0),
            end: new DayPilot.Date("2025-05-26T15:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Mesuji"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-05-27T08:30:00").addDays(0),
            end: new DayPilot.Date("2025-05-27T10:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Lamut"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-05-27T10:45:00").addDays(0),
            end: new DayPilot.Date("2025-05-27T12:45:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Lambar"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-05-27T13:30:00").addDays(0),
            end: new DayPilot.Date("2025-05-27T15:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Balam"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-05-28T08:30:00").addDays(0),
            end: new DayPilot.Date("2025-05-28T10:00:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Pesawaran"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-05-28T10:45:00").addDays(0),
            end: new DayPilot.Date("2025-05-28T12:45:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Lamteng"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-05-28T13:30:00").addDays(0),
            end: new DayPilot.Date("2025-05-14T15:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Tulangbawang"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-06-16T08:00:00").addDays(0),
            end: new DayPilot.Date("2025-06-16T16:00:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Way Kanan"
        });
        ...
        dp.events.add({
            start: new DayPilot.Date("2025-06-17T08:00:00").addDays(0),
            end: new DayPilot.Date("2025-06-17T16:00:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Pesawaran"
        });
        ...
        dp.events.add({
            start: new DayPilot.Date("2025-06-18T08:00:00").addDays(0),
            end: new DayPilot.Date("2025-06-18T16:00:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Tubaba"
        });
        ...
        dp.events.add({
            start: new DayPilot.Date("2025-06-19T08:00:00").addDays(0),
            end: new DayPilot.Date("2025-06-19T16:00:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Balam"
        });
        ...
        dp.events.add({
            start: new DayPilot.Date("2025-06-20T08:00:00").addDays(0),
            end: new DayPilot.Date("2025-06-20T16:00:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Lamtim"
        });
        ...
        dp.events.add({
            start: new DayPilot.Date("2025-06-26T08:30:00").addDays(0),
            end: new DayPilot.Date("2025-06-26T10:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Way Kanan"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-06-26T10:45:00").addDays(0),
            end: new DayPilot.Date("2025-06-26T12:45:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Tulangbawang"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-06-26T13:30:00").addDays(0),
            end: new DayPilot.Date("2025-06-26T15:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Lambar"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-06-30T08:30:00").addDays(0),
            end: new DayPilot.Date("2025-06-30T10:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Pesawaran"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-06-30T10:45:00").addDays(0),
            end: new DayPilot.Date("2025-06-30T12:45:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Lamut"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-06-30T13:30:00").addDays(0),
            end: new DayPilot.Date("2025-06-30T15:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Metro"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-07-01T08:30:00").addDays(0),
            end: new DayPilot.Date("2025-07-01T10:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Tubaba"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-07-01T10:45:00").addDays(0),
            end: new DayPilot.Date("2025-07-01T12:45:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Mesuji"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-07-01T13:30:00").addDays(0),
            end: new DayPilot.Date("2025-07-01T15:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Lamsel"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-07-02T08:30:00").addDays(0),
            end: new DayPilot.Date("2025-07-02T10:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Balam"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-07-02T10:45:00").addDays(0),
            end: new DayPilot.Date("2025-07-02T12:45:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Pesibar"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-07-02T13:30:00").addDays(0),
            end: new DayPilot.Date("2025-07-02T15:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Tanggamus"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-07-03T08:30:00").addDays(0),
            end: new DayPilot.Date("2025-07-03T10:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Lamtim"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-07-03T10:45:00").addDays(0),
            end: new DayPilot.Date("2025-07-03T12:45:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Lamteng"
        });

        dp.events.add({
            start: new DayPilot.Date("2025-07-03T13:30:00").addDays(0),
            end: new DayPilot.Date("2025-07-03T15:30:00").addDays(0).addDays(0),
            id: DayPilot.guid(),
            text: "Pringsewu"
        });
    ...
    <script src="https://e-pengendalian-provlampung.com/gratech/js/script.js"></script>
    <!-- Sidebar -->
    <script src="https://e-pengendalian-provlampung.com/gratech/sidebar/script.js"></script>
