<tr>
    ...
    <td><?= $row['sub_unit']; ?></td>
    <td align="center">
        <a href="<?= hash_url('superadmin/manajemenuser/', ['idUser' => $row['id'], 'action' => 'akftivasi', 'Status' => $row['active'] == 1 ? 1 : 0]);
    ...
    <td align="center">
        <a href="<?= hash_url('superadmin/manajemenuser/', ['idUser' => $row['id'], 'action' => 'pass']);
                    ?>"
            <i class="nav-icon bi bi-star-half">Ubah Password</i>
        </a><br>
        <a href="<?= hash_url('superadmin/manajemenuser/', ['idUser' => $row['id'], 'action' => 'ubahgroup']);
                    ?>" class="btn btn-success btn-circle btn-sm btn-change-group">
            <i class="mdi mdi-google-circles-group">Ubah Rule User</i>
        </a><br>
        <a href="<?= hash_url('superadmin/manajemenuser/', ['idUser' => $row['id'], 'action' => 'ubahperangkatdaerah']);
                    ?>" class="btn btn-success btn-circle btn-sm btn-change-group">
